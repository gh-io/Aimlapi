...
print(response.choices[0].message.content)
 ...
 </td></tr><tr><td valign="top"></td><td valign="top"></td></tr></tbody>
</table>
```
...
## [Search panel] ##
    (https://docs.aimlapi.com/?q=)[image-models](api-referencesapi-docs/refs/heads/main/docs/api-references/text-models-llm/Anthropic/claude-3.7-sonnet.json/image-models/)
    {% endcontent-ref %}
    {% content-ref url="api-references/video-models/" %} 
## [Search panel] ##
(https://docs.aimlapi.com/?q=)
